...
export default function RepositoryTreePage() {
  ...
  const initialPath = Array.isArray(pathSegments) ? pathSegments.join('/') : (pathSegments ?? '');
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      await loadRepoData(repoName, initialPath);
      setCurrentPath(initialPath);
    })();
  }, [repoName, initialPath, router, loadRepoData]);
  ...
  }, [activeDeploymentTask, repoName, currentPath, loadRepoData, toast, repo?.active_deployment_id]);
