  ...
  return (
    <div className="flex-1 bg-background selection:bg-white/20 w-full overflow-x-hidden relative flex flex-col">
      <div className="relative flex-1 flex flex-col">
        <section className="relative flex flex-col items-center justify-center overflow-hidden h-[calc(100dvh-144px)] min-h-[calc(100dvh-144px)] py-12 md:py-0 w-full px-4 md:snap-start md:snap-always shrink-0 md:scroll-mt-16">
        ...
        <section id="features" className="relative flex flex-col items-center lg:justify-center justify-start h-auto lg:h-[calc(100dvh-144px)] min-h-0 lg:min-h-[calc(100dvh-144px)] pt-32 pb-16 md:pt-16 md:pb-8 lg:py-8 w-full px-4 md:snap-start lg:snap-start md:snap-always shrink-0 md:scroll-mt-16">
        ...
        <section className="relative md:snap-start md:snap-always h-auto md:h-[calc(100dvh-144px)] min-h-0 md:min-h-[calc(100dvh-144px)] py-16 md:py-0 w-full flex flex-col md:flex-row items-center justify-center shrink-0 overflow-hidden md:scroll-mt-16">
        ...
        <section className="relative flex flex-col items-center justify-center h-auto md:h-[calc(100dvh-144px)] min-h-0 md:min-h-[calc(100dvh-144px)] py-16 md:py-8 w-full px-4 overflow-hidden md:snap-start md:snap-always shrink-0 md:scroll-mt-16">
